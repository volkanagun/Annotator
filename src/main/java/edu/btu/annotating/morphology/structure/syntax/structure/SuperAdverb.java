 ...
 */
public class SuperAdverb extends Syntheme implements Adverb {
    ...
    public SuperAdverb(Object head, MorphoAnalysis[] path, int pathNo) {
        super(head);
        this.path = path;
        this.pathNo = pathNo;
    ...
    public SuperAdverb(Object head, MorphoAnalysis[] path, int pathNo, ArrayList<Complement> complement, Subcat subcat, int serialNumber) {
        super(head);
        this.path = path;
        this.pathNo = pathNo;
    ...
    public static Function make(Object head, MorphoAnalysis[] path, int pathNo) {
        if (head instanceof Adverb) {
            return new SuperAdverb(head, path, pathNo);
        }
        return null;
    }

    public static SuperAdverb update(SuperAdverb sa, Function item) {
        ArrayList<SuperAdverb> list = new ArrayList();
        SuperAdverb copy = (SuperAdverb) sa.duplicate(); // forking copy
    ...
    public Function duplicate() {
        ...
        return new SuperAdverb(super.getHead(), this.path, this.pathNo, copyComplement, copySubcat, this.serialNumber);
    }
    ...
    public String toString() {
        ...
        if (Settings.printCode == 0) {
            ...
            String separ = " | ", comp = "Complement:", s = "Adverb:";
